...
```
	...
	日常的工作主要是系统的更迭，数据的备份，安全的巡检等工作事项，运维期间，曾搭建过zabbix监控系统监控服务器，并进行邮件告警通知，根据生产环境，搭建过多用户的测试环境，当然还有工作中的电脑网络等系统维护。
	跳槽的原因有三点:1.企业的是国企,发展比较缓慢,2.没有激情,想出来闯一闯,3.自己的提升也比较缓慢,想去大的平台发展，去了上海，入职的是钱香金融.
